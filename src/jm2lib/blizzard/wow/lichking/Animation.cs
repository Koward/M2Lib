...
//ORIGINAL LINE: @Override public void marshal(jm2lib.io.MarshalingStream out) throws java.io.IOException
		...
		public virtual jm2lib.blizzard.wow.legion.Animation upConvert()
		{
			...
			output.startBlendTime = (char) blendTime;
			output.endBlendTime = (char) blendTime;
		...
		public virtual jm2lib.blizzard.wow.classic.Animation downConvert(int initialTime)
		{
			jm2lib.blizzard.wow.classic.Animation output = new jm2lib.blizzard.wow.classic.Animation();
			output.animationID = animationID;
			output.subAnimationID = subAnimationID;
			output.timeStart = initialTime;
			output.timeEnd = initialTime + length;
			output.movingSpeed = movingSpeed;
			output.flags = flags & 0xFF;
			output.probability = probability;
			output.padding = padding;
			output.repetitions = repetitions;
